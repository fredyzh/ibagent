...
public enum IBContracts {
	...
	TNA("TNA", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	IWM("IWM", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	...
	SPXL("SPXL", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	SPY("SPY", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	...
	UNH("UNH", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	CAT("CAT", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	SOXL("SOXL", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	SOXS("SOXS", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	VIX("VIX", IBContractRefs.EXCHANGE_CBOE.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	UVXY("UVXY", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	VXX("VXX", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	V("V", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	AVGO("AVGO", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	COST("COST", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	LLY("LLY", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	CRM("CRM", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	SOXX("SOXX", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName()),
	TRV("TRV", IBContractRefs.EXCHANGE_SMART.getName(), IBContractRefs.EXCHANGE_SMART.getName(),
			IBContractRefs.STK_SEC_TYPE.getName(), IBContractRefs.CURRENCY_USD.getName());
